...
## SQL Practice
- Topic: Aggregations and subqueries
- Problem Statement: Find the department with the highest average salary.
- Solution:
  ```postgresql
  ...
  LIMIT 1;
  ```
- Note: Combining GROUP BY with ORDER BY and LIMIT is a faster way to find the "highest/lowest aggregated value" than using a subquery or HAVING clause.
