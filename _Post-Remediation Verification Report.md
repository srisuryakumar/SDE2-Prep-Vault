...
- **BL-02 & F-05**
  - **What is wrong:** Orphan count is 82 (adjusted), which remains above the critical threshold of 25. Most of these are daily journal notes and LinkedIn posts.
...
- **BL-02:** ❌ STILL FAILING — 82 adjusted orphans remain (well above the 30 limit).
- **BL-03:**
  ...
  | `[[Note Name]]` | Yes | `Knowledge/CS Foundations/Note Name.md` |
  | `[[Note Name]]` | Yes | `Knowledge/CS Foundations/Note Name.md` |
  | `[[Java Compilation Pipeline and Bytecode]]` | No | N/A |
  | `[[Java Compilation and JIT]]` | No | N/A |
...
- **F-05 (CX-01):** ❌ STILL FAILING — Orphan count (82) is not below the critical threshold (25).
